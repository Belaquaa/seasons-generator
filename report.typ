...
#block(width: 100%)[
  ...
  #table(
    ...
    table.cell(align: left + top)[21 июля 2026 года],
  )
]
...
#block(width: 100%)[
  ...
  #table(
    ...
    table.cell(align: center + horizon)[21 июля],
  )
]
...
Рабочий график обучающегося Колесникова В. С., группы М3О-314Б-23, на период с 1 по 21 июля 2026 года.
