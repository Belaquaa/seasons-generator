...
| Сроки практики | с 1 по 21 июля 2026 года |
...
| 10 | 21 июля | Анализ итоговых данных, оформление отчета и финальная проверка материалов. | Описаны результаты 3044 оцененных генераций, подготовлены выводы и иллюстрации. | Выполнено |
