...
| Учебная группа | М3О-314Б-23 |
| Институт | №3 «Системы управления, информатика и электроэнергетика» |
| Кафедра | ______________________________ |
| Направление подготовки | ______________________________ |
| Вид практики | ______________________________ |
| Место проведения практики | ______________________________ |
| Структурное подразделение | ______________________________ |
| Сроки практики | с 1 по 22 июля 2026 года |
| Руководитель практики от МАИ | ______________________________ |
...
Цель практики - подобрать и оценить промпты, которые позволяют получать сезонные варианты исходного изображения для расширения обучающей выборки. Подходит тот результат, где видно заданное время года, сохраняется исходная сцена и не появляются случайные изменения, мешающие дальнейшему сравнению.
...
## Календарный план выполнения индивидуального задания

| № | Период | Содержание работы | Результат | Статус |
| --- | --- | --- | --- | --- |
| 1 | 1 июля | Ознакомление с задачей практики, требованиями к результату и исходными материалами. | Сформулированы цель, индивидуальное задание и критерии приемки результата. | Выполнено |
| 2 | 2–3 июля | Анализ задачи поиска изменений, исходных снимков и сезонных признаков. | Определены сохраняемые элементы сцены и критерии оценки генерации. | Выполнено |
| 3 | 4–5 июля | Подготовка набора типов промптов и сезонных описаний. | Сформирована матрица из десяти типов промптов для четырех сезонов. | Выполнено |
| 4 | 6–8 июля | Настройка генерации, сохранения результатов и параметров запусков. | Получены первые сезонные варианты снимков с зафиксированными параметрами. | Выполнено |
| 5 | 9–11 июля | Подготовка числовой оценки и автоматической проверки результатов. | Настроена оценка сохранения структуры сцены и выраженности сезона. | Выполнено |
| 6 | 12–14 июля | Улучшение формулировок промптов, проверка зимних описаний и исключение лишних изменений сцены. | Выбрана итоговая зимняя формулировка и обновлены промпты. | Выполнено |
| 7 | 15–17 июля | Расширенные прогоны и сравнение моделей FLUX.1-Kontext, SDXL и InstructPix2Pix. | Получены данные для сравнения качества моделей и силы изменения SDXL. | Выполнено |
| 8 | 18–19 июля | Проверка устойчивости результатов, статистическое сравнение типов промптов и выбор лидера. | Подтвержден лучший тип промпта и устойчивость результата к смене начального значения. | Выполнено |
| 9 | 20 июля | Отбор пригодных изображений для дополнительной обучающей выборки и проверка воспроизводимости. | Собран набор принятых изображений и проверена возможность повторного запуска без доступа в интернет. | Выполнено |
| 10 | 21–22 июля | Анализ итоговых данных, оформление отчета и финальная проверка материалов. | Описаны результаты 3044 оцененных генераций, подготовлены выводы и иллюстрации. | Выполнено |
...
Основа этой формулировки - рекомендация из статьи Дэниела [«Flux Kontext Prompt Guide: Master FLUX.1 Dev Image Editing»](https://kontext-dev.com/posts/flux-kontext-prompt-guide-flux1-dev-image-editing). Автор предлагает при смене фона явно фиксировать положение объекта, ракурс, кадрирование и перспективу; здесь эта рекомендация адаптирована для аэро- и спутниковых снимков.
